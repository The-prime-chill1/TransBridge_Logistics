...
export default function CustomerShipmentDetail() {
  ...
  useEffect(() => {
    ...
    // Set up real-time listener for this shipment document
    ...
    <div>
      ...
      <div className={trackStyles.statusCard} style={{ marginBottom: 20 }}>
        ...
        <div className={trackStyles.infoGrid}>
          ...
          <div className={trackStyles.infoItem}><MapPin size={18} className={trackStyles.infoIcon} /><div><span className={trackStyles.infoLabel}>Current Location</span><span className={trackStyles.infoValue}>{shipment.currentLocation || 'N/A'}</span></div></div>
          <div className={trackStyles.infoItem}><Calendar size={18} className={trackStyles.infoIcon} /><div><span className={trackStyles.infoLabel}>Estimated Delivery</span><span className={trackStyles.infoValue}>
            {shipment.estimatedDelivery 
              ? (shipment.estimatedDelivery.toDate 
                  ? shipment.estimatedDelivery.toDate() 
          ...
          <div className={trackStyles.infoItem}><User size={18} className={trackStyles.infoIcon} /><div><span className={trackStyles.infoLabel}>Receiver</span><span className={trackStyles.infoValue}>{shipment.receiverName || shipment.receiver?.name || '—'}</span></div></div>
        </div>
      </div>
